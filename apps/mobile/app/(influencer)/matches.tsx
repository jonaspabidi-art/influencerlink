...
export default function InfluencerMatches() {
    ...
    return (
      <Screen>
        <EmptyState
          ...
          message="När en restaurang också swipar höger på dig hamnar samarbetet här."
        />
      </Screen>
    );
  }
        ...
        renderItem={({ item }) => (
          ...
          >
            <View style={styles.rowText}>
              <Text style={styles.title}>{item.campaign.title}</Text>
              <Caption>
                {item.campaign.businessName} · {item.campaign.city} ·{' '}
